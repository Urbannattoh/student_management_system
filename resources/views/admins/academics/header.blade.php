		...
		<div class="card-body">						
			<div class="vtabs customvtab">
				<ul class="nav nav-tabs tabs-horizontal" role="tablist">
					...
					<li class="nav-item"> <a class="nav-link {{ Request::segment('3') == "times" ? 'active' : ''}}" href="{{ route('times.index') }}" role="tab"><span class="hidden-sm-up"><i class="fa fa-plus-circle"></i></span> <span class="hidden-xs-down">{{ __('Time Slots') }}</span></a> </li>
